import type { ReviewSnapshotRef, VisualReview } from './types';
...
function redactSnapshotTargetSummary(target: ReviewSnapshotRef['targetSummary']): {
  target: ReviewSnapshotRef['targetSummary'];
  redactions: string[];
} {
...
export function redactReview(review: VisualReview): {
  review: VisualReview;
  rules: string[];
